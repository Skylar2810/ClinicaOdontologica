...
return [
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/AdminLTELogo3.png',
            'alt' => '',
            'class' => '',
            'width' => 280,
            'height' => 80,
    ...
    'menu' => [
        ...
        [
         ...
         [
            ...
            'can' => 'eventos.index',  // Esta línea es opcional si usas permisos personalizados
            'roles' => ['Admin'],      // Solo será visible para Admin
        ],
        ...
        [
            ...
            'icon' => 'fas fa-fw fa-calendar',
            'can' => 'eventos.citas', 
            'roles' => ['Paciente'],    // Solo será visible para Pacientes
        ],
